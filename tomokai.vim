...
let g:airline#themes#tomokai#palette = {}
...
let g:airline#themes#tomokai#palette.insert_paste = {
      ...
      \ 'airline_c': [ s:I1[0]   , '#d78700' , s:I1[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#tomokai#palette.replace = copy(g:airline#themes#tomokai#palette.insert)
let g:airline#themes#tomokai#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
let g:airline#themes#tomokai#palette.replace_modified = g:airline#themes#tomokai#palette.insert_modified
...
let g:airline#themes#tomokai#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
let g:airline#themes#tomokai#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 97 , '' , '' ] ,
      \ }
...
let g:airline#themes#tomokai#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
let g:airline#themes#tomokai#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
