...
if exists("g:tomokai_original")
    let s:tomokai_original = g:tomokai_original
else
    let s:tomokai_original = 0
endif
...
hi SpecialComment         guifg=#2A98FF
...
if s:tomokai_original == 1
   hi Normal          guifg=#F8F8F2 guibg=#272822
   "hi Comment         guifg=#75715E
   hi Comment         guifg=#2A98FF
...
if &t_Co > 255
   ...
   hi Identifier      ctermfg=195               cterm=none
   ...
   hi Visual                      ctermbg=239   cterm=bold
